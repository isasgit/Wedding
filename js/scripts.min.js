...
$(document).ready(function () {
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function (e) {
        ...
        $("#alert-wrapper").html(alert_markup("info", "<strong>Saving your details!")),  $.post("https://script.google.com/macros/s/AKfycbwfuJdNl9SWf2ueV8xZ32ooOQFvBdiM3Y7OEEMBos0JGsy-TFuXFTfKSahQI7ivOKYGpQ/exec", t).done(function (e) {
