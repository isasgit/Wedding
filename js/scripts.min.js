...
$(document).ready(function() {
  $(".wp1").waypoint(
    ...
    $(".nav-toggle").click(function() {
      $(this).toggleClass("active"),
        ...
        $(".header-nav li a").toggleClass("white"),
  ...
  $(".player").YTPlayer(),
    $("#rsvp-form").on("submit", function(e) {
      ...
      $("#alert-wrapper").html(
        alert_markup("info", "<strong>Se trimite confirmarea!")
      ),
        $.post(
          "https://script.google.com/macros/s/AKfycbxcjnefyncSy8rIhR0lKNd-DX36qKIutq2Hk7xDB-6sHNB6k5PEpaTnQci6MibjSxjd/exec",
          t
        )
          .done(function(e) {
            console.log(),
          ...
          .fail(function(e) {
            console.log(),
              $("#alert-wrapper").html(
                alert_markup(
                  "danger",
                  "<strong>Sorry!</strong> A aparut o problema. Va rugam sa incercati din nou! "
                )
              );
          });
    });
...
var MD5 = function(e) {
  ...
  for (
    ...
    (f = t((s = f), (p = g), (d = h), (m = u), w[i + 0], 7, 3614090360)),
      ...
      (f = o(
        f,
        (g = n(g, h, u, f, w[i + 2], 23, 3299628645)),
        h,
        u,
        w[i + 0],
        6,
