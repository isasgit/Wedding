function initMap() {
    var e = {
            lat: 44.73365697101591,
            lng: 26.176628703173872
        },
...
$(document).ready(function () {
    ...
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function (e) {
        ...
        $("#alert-wrapper").html(alert_markup("info", "<strong>Just a sec!</strong> We are saving your details.")),  $.post("https://script.google.com/macros/s/AKfycbyVZkC9zuyGfPDR0dMWwiYwuZ7LrKR4jPKjeBiB7htElXrY0N4201sQYpf_BnOFq1j2ng/exec", t).done(function (e) {
